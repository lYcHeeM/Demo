...
//        label.layer.masksToBounds = true
    ...
    func setupContent(imgName imgName: String) {
        imgView1.layer.shouldRasterize = true
        imgView1.layer.rasterizationScale = UIScreen.mainScreen().scale
        imgView2.layer.shouldRasterize = true
        imgView2.layer.rasterizationScale = UIScreen.mainScreen().scale
