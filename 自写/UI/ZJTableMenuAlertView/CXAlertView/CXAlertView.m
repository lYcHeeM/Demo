...
// on 150430
// original is 10.
static CGFloat const kDefaultScrollViewPadding = 5.;
#pragma mark end
...
#pragma mark - by Zhijun
// on 150504
// original is static CGFloat const kDefaultContainerWidth = 280.;
#define kDefaultContainerWidth CXAlertViewDefaultWidth
#pragma mark end
...
- (void)updateTopScrollView
{
    if (self.title) {
        ...
        _topScrollView.backgroundColor = _viewBackgroundColor ? _viewBackgroundColor : [UIColor whiteColor];
    }
    else {
...
#pragma mark - by Zhijun
        ...
        _contentScrollView.backgroundColor = _viewBackgroundColor ? _viewBackgroundColor : [UIColor whiteColor];
#pragma mark end
...
#pragma mark - by Zhijun
    ...
    _bottomScrollView.backgroundColor = _viewBackgroundColor ? _viewBackgroundColor : [UIColor whiteColor];
#pragma mark end
...
- (CXAlertButtonItem *)buttonItemWithType:(CXAlertViewButtonType)type font:(UIFont *)font
{
	CXAlertButtonItem *button = [CXAlertButtonItem buttonWithType:UIButtonTypeSystem];
